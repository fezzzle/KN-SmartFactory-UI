...
class CompanyAdmin extends Component {
  ...
  getUsers = async () => {
    const config = {
      headers: { Authorization: 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImF1dGgiOiJST0xFX0FETUlOLFJPTEVfUEVSTUlTU0lPTl9DUkVBVEUsUk9MRV9QRVJNSVNTSU9OX0RFTEVURSxST0xFX1BFUk1JU1NJT05fUkVBRCxST0xFX1BFUk1JU1NJT05fVVBEQVRFLFJPTEVfVVNFUiIsImV4cCI6MTYyMzU5NzM5NX0.9s19D5CgWgShdbGS1hhAEuyBln5Cn6UrROQE7q9p20RCthKaoFebtVD-pOJDkNOXmtfWHQxRdQ2OZG-CYQXlVA',
    }
  };
    axios
