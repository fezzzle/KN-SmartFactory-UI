...
class BootstrapModal extends React.Component {
  ...
  handleSubmit = async () => {
    ...
    const config = {
      Authorization:
        "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImF1dGgiOiJST0xFX0FETUlOLFJPTEVfUEVSTUlTU0lPTl9DUkVBVEUsUk9MRV9QRVJNSVNTSU9OX0RFTEVURSxST0xFX1BFUk1JU1NJT05fUkVBRCxST0xFX1BFUk1JU1NJT05fVVBEQVRFLFJPTEVfVVNFUiIsImV4cCI6MTYyMzg0MTM1MX0.HNphRWszkPCuhgi9SDvmLN4FpJyApqPf0cuYRF-lSPkhD6NGCaGFhra4cf4i-oRITdgtHQlIwBSFfhbid3bjGg",
