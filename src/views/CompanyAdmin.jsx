...
class CompanyAdmin extends Component {
  ...
  getUsers = async () => {
    const config = {
      headers: { Authorization: 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImF1dGgiOiJST0xFX0FETUlOLFJPTEVfUEVSTUlTU0lPTl9DUkVBVEUsUk9MRV9QRVJNSVNTSU9OX0RFTEVURSxST0xFX1BFUk1JU1NJT05fUkVBRCxST0xFX1BFUk1JU1NJT05fVVBEQVRFLFJPTEVfVVNFUiIsImV4cCI6MTYyMzYxODkzMH0.cA6ev0d-qmvl4k6kj7_6D9JXuwXiOrpXM48l5OzwjyXcHVlwXdotUrzd1OsbvSDKhoPK-YoSE25sbrD57OWYwQ',
    }
  };
    axios
